...
#ifndef _TAO_IDL_RTPSCORES_2BW61Z_H_
#define _TAO_IDL_RTPSCORES_2BW61Z_H_

#include /**/ "ace/pre.h"

#include "RtpsCoreC.h"
#include "dds/OpenddsDcpsExtS.h"
...
namespace TAO
{
  ...
  template<>
  class SArg_Traits< ::OpenDDS::RTPS::Duration_t>
    : public
        Fixed_Size_SArg_Traits_T<
  ...
  template<>
  class SArg_Traits< ::OpenDDS::RTPS::ReliabilityQosPolicyRtps>
    : public
        Fixed_Size_SArg_Traits_T<
  ...
  template<>
  class SArg_Traits< ::OpenDDS::RTPS::Message>
    : public
        Var_Size_SArg_Traits_T<
