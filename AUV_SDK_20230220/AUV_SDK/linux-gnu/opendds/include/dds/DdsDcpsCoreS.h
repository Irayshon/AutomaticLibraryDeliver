...
#ifndef _TAO_IDL_DDSDCPSCORES_E3PYEL_H_
#define _TAO_IDL_DDSDCPSCORES_E3PYEL_H_
...
namespace TAO
{
  ...
  template<>
  class SArg_Traits< ::DDS::DataRepresentationIdSeq>
    : public
        Var_Size_SArg_Traits_T<
  ...
  template<>
  class SArg_Traits< ::DDS::DataRepresentationQosPolicy>
    : public
        Var_Size_SArg_Traits_T<
  ...
  template<>
  class SArg_Traits< ::DDS::TypeConsistencyEnforcementQosPolicy>
    : public
        Fixed_Size_SArg_Traits_T<
  ...
  template<>
  class SArg_Traits< ::DDS::OctetArray16_tag>
    : public
