...
#ifndef _TAO_PIDL_DOUBLESEQC_84FHUG_H_
#define _TAO_PIDL_DOUBLESEQC_84FHUG_H_
...
#define _CORBA_DOUBLESEQ_CH_
  ...
  public:
    ...
    DoubleSeq (const DoubleSeq &) = default;
    DoubleSeq (DoubleSeq &&) = default;
    DoubleSeq& operator= (const DoubleSeq &) = default;
    DoubleSeq& operator= (DoubleSeq &&) = default;
#endif /* ACE_HAS_CPP11 */
...
// be/be_visitor_template_export.cpp:39
  ...
  template class TAO_Export ::TAO::unbounded_value_sequence< ::CORBA::Double>;
