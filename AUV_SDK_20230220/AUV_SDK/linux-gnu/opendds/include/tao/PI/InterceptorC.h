...
#ifndef _TAO_PIDL_INTERCEPTORC_A7OTBE_H_
#define _TAO_PIDL_INTERCEPTORC_A7OTBE_H_
...
#define _PORTABLEINTERCEPTOR_INTERCEPTOR__VAR_OUT_CH_
  ...
  private:
    ...
    ACE_UNIMPLEMENTED_FUNC (Interceptor (const Interceptor &))
#if defined (ACE_HAS_CPP11)
    ACE_UNIMPLEMENTED_FUNC (Interceptor (Interceptor &&))
#endif /* ACE_HAS_CPP11 */
    ACE_UNIMPLEMENTED_FUNC (Interceptor &operator= (const Interceptor &))
#if defined (ACE_HAS_CPP11)
    ACE_UNIMPLEMENTED_FUNC (Interceptor &operator= (Interceptor &&))
#endif /* ACE_HAS_CPP11 */
  };
