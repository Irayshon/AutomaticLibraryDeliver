...
#ifndef _TAO_PIDL_LONGDOUBLESEQC_J3QZWL_H_
#define _TAO_PIDL_LONGDOUBLESEQC_J3QZWL_H_
...
#define _CORBA_LONGDOUBLESEQ_CH_
  ...
  public:
    ...
    LongDoubleSeq (const LongDoubleSeq &) = default;
    LongDoubleSeq (LongDoubleSeq &&) = default;
    LongDoubleSeq& operator= (const LongDoubleSeq &) = default;
    LongDoubleSeq& operator= (LongDoubleSeq &&) = default;
#endif /* ACE_HAS_CPP11 */
...
// be/be_visitor_template_export.cpp:39
  ...
  template class TAO_Export ::TAO::unbounded_value_sequence< ::CORBA::LongDouble>;
