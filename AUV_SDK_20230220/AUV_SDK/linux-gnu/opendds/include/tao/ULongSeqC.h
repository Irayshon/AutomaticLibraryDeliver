...
#ifndef _TAO_PIDL_ULONGSEQC_DYOED6_H_
#define _TAO_PIDL_ULONGSEQC_DYOED6_H_
...
#define _CORBA_ULONGSEQ_CH_
  ...
  public:
    ...
    ULongSeq (const ULongSeq &) = default;
    ULongSeq (ULongSeq &&) = default;
    ULongSeq& operator= (const ULongSeq &) = default;
    ULongSeq& operator= (ULongSeq &&) = default;
#endif /* ACE_HAS_CPP11 */
...
// be/be_visitor_template_export.cpp:39
  ...
  template class TAO_Export ::TAO::unbounded_value_sequence< ::CORBA::ULong>;
