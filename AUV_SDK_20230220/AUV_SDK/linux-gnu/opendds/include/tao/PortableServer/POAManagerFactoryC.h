...
#ifndef _TAO_PIDL_POAMANAGERFACTORYC_ED8GLJ_H_
#define _TAO_PIDL_POAMANAGERFACTORYC_ED8GLJ_H_
...
#define _PORTABLESERVER_POAMANAGERFACTORY_POAMANAGERSEQ_CH_
  ...
  private:
    ...
    ACE_UNIMPLEMENTED_FUNC (POAManagerFactory (const POAManagerFactory &))
#if defined (ACE_HAS_CPP11)
    ACE_UNIMPLEMENTED_FUNC (POAManagerFactory (POAManagerFactory &&))
#endif /* ACE_HAS_CPP11 */
    ACE_UNIMPLEMENTED_FUNC (POAManagerFactory &operator= (const POAManagerFactory &))
#if defined (ACE_HAS_CPP11)
    ACE_UNIMPLEMENTED_FUNC (POAManagerFactory &operator= (POAManagerFactory &&))
#endif /* ACE_HAS_CPP11 */
  };
  // TAO_IDL - Generated from
  // be/be_visitor_typecode/typecode_decl.cpp:36
