...
#ifndef _TAO_PIDL_THREADPOLICYC_PNKAKE_H_
#define _TAO_PIDL_THREADPOLICYC_PNKAKE_H_
...
#define _PORTABLESERVER_THREADPOLICY__VAR_OUT_CH_
  ...
  private:
    ...
    ACE_UNIMPLEMENTED_FUNC (ThreadPolicy (const ThreadPolicy &))
#if defined (ACE_HAS_CPP11)
    ACE_UNIMPLEMENTED_FUNC (ThreadPolicy (ThreadPolicy &&))
#endif /* ACE_HAS_CPP11 */
    ACE_UNIMPLEMENTED_FUNC (ThreadPolicy &operator= (const ThreadPolicy &))
#if defined (ACE_HAS_CPP11)
    ACE_UNIMPLEMENTED_FUNC (ThreadPolicy &operator= (ThreadPolicy &&))
#endif /* ACE_HAS_CPP11 */
  };
