...
#ifndef _TAO_PIDL_ADAPTERACTIVATORC_BEJFOE_H_
#define _TAO_PIDL_ADAPTERACTIVATORC_BEJFOE_H_
...
#define _PORTABLESERVER_ADAPTERACTIVATOR__VAR_OUT_CH_
  ...
  private:
    ...
    ACE_UNIMPLEMENTED_FUNC (AdapterActivator (const AdapterActivator &))
#if defined (ACE_HAS_CPP11)
    ACE_UNIMPLEMENTED_FUNC (AdapterActivator (AdapterActivator &&))
#endif /* ACE_HAS_CPP11 */
    ACE_UNIMPLEMENTED_FUNC (AdapterActivator &operator= (const AdapterActivator &))
#if defined (ACE_HAS_CPP11)
    ACE_UNIMPLEMENTED_FUNC (AdapterActivator &operator= (AdapterActivator &&))
#endif /* ACE_HAS_CPP11 */
  };
