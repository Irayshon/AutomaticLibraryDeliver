...
// The IAR compiler (8.32.3) is unable to compile the code
// that returns an auto_ptr.  Existing usage within TAO
// does not require it to be returned as an auto_ptr.
#if defined (ACE_MQX) && defined (__IAR_SYSTEMS_ICC__)
