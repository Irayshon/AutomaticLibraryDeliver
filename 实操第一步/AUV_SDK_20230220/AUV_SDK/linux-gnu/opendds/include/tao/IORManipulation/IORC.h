...
#ifndef _TAO_PIDL_IORC_51WPJC_H_
#define _TAO_PIDL_IORC_51WPJC_H_
...
#define _TAO_IOP_TAO_IOR_PROPERTY__VAR_OUT_CH_
  ...
  private:
    ...
    ACE_UNIMPLEMENTED_FUNC (TAO_IOR_Property (const TAO_IOR_Property &))
#if defined (ACE_HAS_CPP11)
    ACE_UNIMPLEMENTED_FUNC (TAO_IOR_Property (TAO_IOR_Property &&))
#endif /* ACE_HAS_CPP11 */
    ACE_UNIMPLEMENTED_FUNC (TAO_IOR_Property &operator= (const TAO_IOR_Property &))
#if defined (ACE_HAS_CPP11)
    ACE_UNIMPLEMENTED_FUNC (TAO_IOR_Property &operator= (TAO_IOR_Property &&))
#endif /* ACE_HAS_CPP11 */
  };
  // TAO_IDL - Generated from
  // be/be_visitor_typecode/typecode_decl.cpp:36
...
#define _TAO_IOP_TAO_IOR_MANIPULATION_IORLIST_CH_
  ...
  private:
    // Private and unimplemented for concrete interfaces.
    ACE_UNIMPLEMENTED_FUNC (TAO_IOR_Manipulation (const TAO_IOR_Manipulation &))
#if defined (ACE_HAS_CPP11)
    ACE_UNIMPLEMENTED_FUNC (TAO_IOR_Manipulation (TAO_IOR_Manipulation &&))
#endif /* ACE_HAS_CPP11 */
    ACE_UNIMPLEMENTED_FUNC (TAO_IOR_Manipulation &operator= (const TAO_IOR_Manipulation &))
#if defined (ACE_HAS_CPP11)
    ACE_UNIMPLEMENTED_FUNC (TAO_IOR_Manipulation &operator= (TAO_IOR_Manipulation &&))
#endif /* ACE_HAS_CPP11 */
  };
  // TAO_IDL - Generated from
  // be/be_visitor_typecode/typecode_decl.cpp:36
...
// TAO_IDL - Generated from
// be/be_visitor_exception/cdr_op_ch.cpp:39
