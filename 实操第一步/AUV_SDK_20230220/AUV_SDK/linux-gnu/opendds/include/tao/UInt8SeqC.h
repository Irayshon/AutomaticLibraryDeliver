...
#ifndef _TAO_PIDL_UINT8SEQC_B6DGQI_H_
#define _TAO_PIDL_UINT8SEQC_B6DGQI_H_
...
#if !defined (_CORBA_UINT8SEQ_CH_)
#define _CORBA_UINT8SEQ_CH_
...
namespace TAO
{
  ...
  template<>
  class Arg_Traits< ::CORBA::UInt8Seq>
    : public
...
// TAO_IDL - Generated from
// be/be_visitor_template_export.cpp:39

#if defined ACE_HAS_EXPLICIT_TEMPLATE_INSTANTIATION_EXPORT
  template class TAO_Export ::TAO::unbounded_value_sequence< ::CORBA::UInt8, CORBA::IDLv4::UInt8_tag>;
...
#if !defined _TAO_CDR_OP_CORBA_UInt8Seq_H_
#define _TAO_CDR_OP_CORBA_UInt8Seq_H_
...
TAO_Export ::CORBA::Boolean operator<< (
    TAO_OutputCDR &strm,
    const CORBA::UInt8Seq &_tao_sequence);
TAO_Export ::CORBA::Boolean operator>> (
    TAO_InputCDR &strm,
    CORBA::UInt8Seq &_tao_sequence);
...
#endif /* _TAO_CDR_OP_CORBA_UInt8Seq_H_ */
// TAO_IDL - Generated from
