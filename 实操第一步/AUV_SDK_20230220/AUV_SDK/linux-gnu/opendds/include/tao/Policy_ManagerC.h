...
#ifndef _TAO_PIDL_POLICY_MANAGERC_2Z0JLW_H_
#define _TAO_PIDL_POLICY_MANAGERC_2Z0JLW_H_
...
#define _CORBA_POLICYMANAGER__VAR_OUT_CH_
  ...
  private:
    ...
    ACE_UNIMPLEMENTED_FUNC (PolicyManager (const PolicyManager &))
#if defined (ACE_HAS_CPP11)
    ACE_UNIMPLEMENTED_FUNC (PolicyManager (PolicyManager &&))
#endif /* ACE_HAS_CPP11 */
    ACE_UNIMPLEMENTED_FUNC (PolicyManager &operator= (const PolicyManager &))
#if defined (ACE_HAS_CPP11)
    ACE_UNIMPLEMENTED_FUNC (PolicyManager &operator= (PolicyManager &&))
#endif /* ACE_HAS_CPP11 */
  };
