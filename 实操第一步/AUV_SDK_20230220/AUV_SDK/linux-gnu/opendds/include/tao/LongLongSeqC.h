...
#ifndef _TAO_PIDL_LONGLONGSEQC_W2CS5J_H_
#define _TAO_PIDL_LONGLONGSEQC_W2CS5J_H_
...
#define _CORBA_LONGLONGSEQ_CH_
  ...
  public:
    ...
    LongLongSeq (const LongLongSeq &) = default;
    LongLongSeq (LongLongSeq &&) = default;
    LongLongSeq& operator= (const LongLongSeq &) = default;
    LongLongSeq& operator= (LongLongSeq &&) = default;
#endif /* ACE_HAS_CPP11 */
...
// be/be_visitor_template_export.cpp:39
  ...
  template class TAO_Export ::TAO::unbounded_value_sequence< ::CORBA::LongLong>;
