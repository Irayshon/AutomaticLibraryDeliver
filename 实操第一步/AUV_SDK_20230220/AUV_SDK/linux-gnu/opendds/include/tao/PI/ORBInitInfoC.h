...
#ifndef _TAO_PIDL_ORBINITINFOC_OCXG8M_H_
#define _TAO_PIDL_ORBINITINFOC_OCXG8M_H_
...
#define _PORTABLEINTERCEPTOR_ORBINITINFO__VAR_OUT_CH_
  ...
  public:
    ...
    public:
      ...
      // TAO_IDL - Generated from
      // be/be_visitor_exception/exception_ctor.cpp:53
  ...
  private:
    ...
    ACE_UNIMPLEMENTED_FUNC (ORBInitInfo (const ORBInitInfo &))
#if defined (ACE_HAS_CPP11)
    ACE_UNIMPLEMENTED_FUNC (ORBInitInfo (ORBInitInfo &&))
#endif /* ACE_HAS_CPP11 */
    ACE_UNIMPLEMENTED_FUNC (ORBInitInfo &operator= (const ORBInitInfo &))
#if defined (ACE_HAS_CPP11)
    ACE_UNIMPLEMENTED_FUNC (ORBInitInfo &operator= (ORBInitInfo &&))
#endif /* ACE_HAS_CPP11 */
  };
  // TAO_IDL - Generated from
  // be/be_visitor_typecode/typecode_decl.cpp:36
...
#define _PORTABLEINTERCEPTOR_ORBINITINFO_3_1__VAR_OUT_CH_
  ...
  private:
    // Private and unimplemented for concrete interfaces.
    ACE_UNIMPLEMENTED_FUNC (ORBInitInfo_3_1 (const ORBInitInfo_3_1 &))
#if defined (ACE_HAS_CPP11)
    ACE_UNIMPLEMENTED_FUNC (ORBInitInfo_3_1 (ORBInitInfo_3_1 &&))
#endif /* ACE_HAS_CPP11 */
    ACE_UNIMPLEMENTED_FUNC (ORBInitInfo_3_1 &operator= (const ORBInitInfo_3_1 &))
#if defined (ACE_HAS_CPP11)
    ACE_UNIMPLEMENTED_FUNC (ORBInitInfo_3_1 &operator= (ORBInitInfo_3_1 &&))
#endif /* ACE_HAS_CPP11 */
  };
  // TAO_IDL - Generated from
  // be/be_visitor_typecode/typecode_decl.cpp:36
