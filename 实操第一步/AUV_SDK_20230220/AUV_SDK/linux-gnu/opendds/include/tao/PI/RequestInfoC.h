...
#ifndef _TAO_PIDL_REQUESTINFOC_HEBGSB_H_
#define _TAO_PIDL_REQUESTINFOC_HEBGSB_H_
...
#define _PORTABLEINTERCEPTOR_REQUESTINFO__VAR_OUT_CH_
  ...
  private:
    ...
    ACE_UNIMPLEMENTED_FUNC (RequestInfo (const RequestInfo &))
#if defined (ACE_HAS_CPP11)
    ACE_UNIMPLEMENTED_FUNC (RequestInfo (RequestInfo &&))
#endif /* ACE_HAS_CPP11 */
    ACE_UNIMPLEMENTED_FUNC (RequestInfo &operator= (const RequestInfo &))
#if defined (ACE_HAS_CPP11)
    ACE_UNIMPLEMENTED_FUNC (RequestInfo &operator= (RequestInfo &&))
#endif /* ACE_HAS_CPP11 */
  };
