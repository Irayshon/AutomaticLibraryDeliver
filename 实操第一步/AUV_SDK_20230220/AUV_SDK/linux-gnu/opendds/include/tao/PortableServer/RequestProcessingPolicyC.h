...
#ifndef _TAO_PIDL_REQUESTPROCESSINGPOLICYC_EMZRA7_H_
#define _TAO_PIDL_REQUESTPROCESSINGPOLICYC_EMZRA7_H_
...
#define _PORTABLESERVER_REQUESTPROCESSINGPOLICY__VAR_OUT_CH_
  ...
  private:
    ...
    ACE_UNIMPLEMENTED_FUNC (RequestProcessingPolicy (const RequestProcessingPolicy &))
#if defined (ACE_HAS_CPP11)
    ACE_UNIMPLEMENTED_FUNC (RequestProcessingPolicy (RequestProcessingPolicy &&))
#endif /* ACE_HAS_CPP11 */
    ACE_UNIMPLEMENTED_FUNC (RequestProcessingPolicy &operator= (const RequestProcessingPolicy &))
#if defined (ACE_HAS_CPP11)
    ACE_UNIMPLEMENTED_FUNC (RequestProcessingPolicy &operator= (RequestProcessingPolicy &&))
#endif /* ACE_HAS_CPP11 */
  };
