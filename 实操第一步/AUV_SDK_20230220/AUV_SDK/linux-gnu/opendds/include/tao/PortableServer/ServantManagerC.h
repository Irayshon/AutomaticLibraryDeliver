...
#ifndef _TAO_PIDL_SERVANTMANAGERC_42EUMN_H_
#define _TAO_PIDL_SERVANTMANAGERC_42EUMN_H_
...
#define _PORTABLESERVER_SERVANTMANAGER__VAR_OUT_CH_
  ...
  private:
    ...
    ACE_UNIMPLEMENTED_FUNC (ServantManager (const ServantManager &))
#if defined (ACE_HAS_CPP11)
    ACE_UNIMPLEMENTED_FUNC (ServantManager (ServantManager &&))
#endif /* ACE_HAS_CPP11 */
    ACE_UNIMPLEMENTED_FUNC (ServantManager &operator= (const ServantManager &))
#if defined (ACE_HAS_CPP11)
    ACE_UNIMPLEMENTED_FUNC (ServantManager &operator= (ServantManager &&))
#endif /* ACE_HAS_CPP11 */
  };
